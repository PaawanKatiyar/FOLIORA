const Post = () => {
  return (
    <section className = "min-h-[500px] bg-[#ECECE7] text-center px-12 py-12">
      <div>
        <h3 className = "head-font text-6xl mt-8">NEW LITERATURE POSTS</h3>
        <div className = "border-b mx-auto w-12 mt-8"></div>
      </div>
      <div className = "flex justify-center gap-25 mt-12">
        <div>
          <img className = "w-100 h-100" src="../public/images/post/@g_readss on insta 🌷.jpg" alt=""/>
          <div className = "text-left">
            ...
            <div className = "flex text-sm body-font items-center">
              ...
              <span className = "border-r h-4 mr-2"></span>
              <p className = "">1 COMMENT</p>
            </div>
          </div>
        </div>
        <div>
          <img className = "w-100 h-100"  src="../public/images/post/Atomic Habits.jpg" alt=""/>
          <div className = "text-left">
        ...
        <div>
          <img className = "w-100 h-100"  src="../public/images/post/clarie biggs - taming 7.jpg" alt=""/>
          <div className = "text-left">
      ...
      <div className = "flex justify-center gap-25 mt-12">
        <div>
          <img className = "w-100 h-100" src="../public/images/post/Register - Login.jpg" alt=""/>
          <div className = "text-left">
        ...
        <div>
          <img className = "w-100 h-100" src="../public/images/post/asphyvx on instagram.jpg" alt=""/>
          <div className = "text-left">
        ...
        <div>
          <img className = "w-100 h-100" src="../public/images/post/classic.jpg" alt=""/>
          <div className = "text-left">
